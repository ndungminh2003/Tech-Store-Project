  ...
  return (
    <div className="admin">
      <div className="flex justify-between items-center">
        <h3 className="mb-4 title text-3xl font-bold">View Enquiry</h3>
        <button
      ...
      <div className="mt-5 bg-white p-6 flex gap-3 flex-col rounded-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <select
              ...
              className="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded form-select"
              id=""
