...
export default function Banner() {
  ...
  return (
    ...
    <div className=' container mx-auto flex gap-2 justify-between '>
        ...
        <div id='catalog' className=' relative flex flex-col gap-1 w-60 border-2 rounded-3xl ml-2 mt-4 shadow-lg shadow-gray-400 min-w-max h-fit xxsm:hidden xsm:hidden sm:hidden '>
          { 
            catalog.map( c => (
          ...
          {
            hoveredElement && (
              <div onMouseMove={ () => handleMouseOver(hoveredElement)} onMouseOut={handleMouseLeave} className=" absolute w-[84rem] xl:w-[68rem] lg:w-[52rem] md:w-[38rem] h-fit bg-slate-100 left-full rounded-xl z-40">
