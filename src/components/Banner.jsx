...
export default function Banner() {
  ...
  return (
    ...
    <div className=' container mx-auto flex gap-2 justify-between '>
        ...
        <div id='catalog' className=' relative flex flex-col gap-1 w-60 border-2 rounded-3xl ml-2 mt-8 shadow-lg shadow-gray-400 min-w-max h-fit xxsm:hidden xsm:hidden sm:hidden '>
          { 
            catalog.map( c => (
