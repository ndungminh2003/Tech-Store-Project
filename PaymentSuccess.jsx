  ...
  return (
    <div className="">
      <div className="tw-flex tw-items-center tw-justify-center tw-max-w-[700px] tw-m-auto tw-my-5">
        ...
        >
          <div className="!tw-text-base tw-text-[#d70018] tw-justify-start tw-flex tw-items-center tw-font-semibold">
            <ArrowBackIosIcon />
            <h1 className="hover:tw-underline">Đóng</h1>
          </div>
      ...
      <div className="tw-bg-[#fef2f2] tw-max-w-[600px] tw-m-auto tw-rounded-[15px]">
        <div className="tw-max-w-[600px] tw-m-auto tw-p-4 flex tw-items-center ">
      ...
      c0-27.619,22.468-50.087,50.087-50.087s50.087,22.468,50.087,50.087C445.217,350.402,422.75,372.87,395.13,372.87z"
          ...
          <div className="tw-w-[20%] tw-flex tw-flex-col tw-gap-1 tw-items-center tw-text-xs tw-text-[#0e2431] tw-process-item tw-relative tw-active">
            ...
            <p className="tw-text-[#d70018]">Hoàn tất đặt hàng</p>
          </div>
        </div>

        <div className="tw-bg-white tw-p-[10px] tw-shadow-cellphone tw-rounded-[15px]">
          <div>
            <p>
          ...
          <div className="tw-p-[10px] tw-bg-[#d4edda] shadow-cellphone tw-rounded-[15px]">
            <div className="tw-p-[10px] tw-text-[#155724]">
              ...
              <p className="tw-font-bold tw-text-lg tw-my-[15px]">
                <span className="tw-font-normal">Hình Thức Thanh Toán: </span>
          ...
          <div className="tw-bg-white tw-mt-3 tw-shadow-cellphone tw-p-[10px] tw-rounded-[15px]">
            <div className="tw-flex tw-gap-[10px] tw-p-[5px] tw-mb-[10px] tw-shadow-cellphone tw-rounded-[15px]">
              <div className="tw-w-[calc(25%-5px)]">
                <img
                  src="https://image.cellphones.com.vn/200x/media/catalog/product/t/_/t_m_21.png"
                  alt=""
                />
              </div>
              <div className="tw-text-base tw-font-semibold tw-text-[#0e2431]">
                <p className="tw-my-[5px]">iPhone 14 Pro Max 256GB-Tím</p>
                <p className="tw-my-[5px]">
                  <span className="tw-font-normal">Giá:</span> 29.290.000 ₫
                  <del className="tw-text-[15px] tw-font-normal tw-text-[#777777]">
                    32.990.000 ₫
                  </del>
                </p>
                <p className="tw-my-[5px]">
                  <span className="tw-font-normal">Số lượng:</span> 1
                </p>
                <p className=" tw-my-[5px]">
                  <span className="tw-font-normal">Tổng tiền:</span> 29.290.000 ₫
                </p>
              </div>
            </div>
            <div className="tw-flex tw-gap-[10px] tw-p-[5px] tw-mb-[10px] shadow-cellphone tw-rounded-[15px]">
              <div className="tw-w-[calc(25%-5px)]">
                <img
                  src="https://image.cellphones.com.vn/200x/media/catalog/product/t/_/t_m_21.png"
                  alt=""
          ...
          <div className="tw-flex tw-items-center tw-gap-3 tw-my-3">
            <button className="tw-rounded-[15px] tw-flex tw-flex-col tw-items-center tw-gap-1 tw-w-1/2 tw-px-3 tw-py-[6px] tw-bg-[#007bff] tw-text-white tw-text-base tw-font-semibold">
              <h1>Kiểm tra đơn hàng</h1>
              <CheckCircleIcon />
            </button>
            <button className="tw-rounded-[15px] tw-flex tw-flex-col tw-items-center tw-gap-1 tw-w-1/2 tw-px-3 tw-py-[6px] tw-bg-[#dc3545] tw-text-white tw-text-base tw-font-semibold">
              <Link to="/">
          ...
          <div>
            <button className="tw-rounded-[15px] tw-px-3 tw-py-[6px] tw-bg-[#28a745] tw-text-white tw-text-base tw-font-semibold tw-w-full ">
      ...
      <div className="tw-w-full tw-max-w-[670px] tw-m-auto tw-bg-white tw-shadow-cellphone tw-rounded-md tw-p-[10px] tw-mt-5">
