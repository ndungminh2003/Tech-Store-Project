...
const Question = () => {
  ...
  return (
    <div className="tw-my-5 tw-p-4 tw-shadow-cellphone">
      <h1 className="tw-text-2xl tw-text-[#d02c35] tw-font-bold tw-text-center tw-uppercase">
        Câu hỏi thường gặp
      </h1>
      <Accordion
      ...
      >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography className="!tw-text-[#000] !tw-font-semibold !tw-text-[15px]">
            Bút S-Pen có được trang bị sẵn trên Samsung Galaxy S22 Ultra không?
            Có những tính năng nào nổi bật?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography className="!tw-text-sm !tw-text-[#4a4a4a]">
